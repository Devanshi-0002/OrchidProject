...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="mini-search-row">
        <div class="container">
            <a style="color: white" href="Default.aspx">Home ></a> <a id="packagetypeforBreadCrumbs" runat="server" style="color: white"></a>
        </div>
        <div class="container">
            <div class="row">
        ...
        <div class="package-price-box">
            <div class="dastination-slider-price-box package-details-price-tab">
                ...
                <ul class="dastination-slider-price-btn">
                    ...
                    <li id="boolnow_btn" runat="server">
                    ...
                    <div class="dastination-package-main">
                        ...
                        <div class="tab-content pr-sm-0 dastination-tab-content">
                            ...
                            <div class="tab-pane" id="InclusionsExclusions" role="tabpanel">
                                <h4>Inclusions :</h4>
                                <span id="Inclutions" runat="server"></span>
                                <br />
                                <h4>Exclusions :</h4>
    ...
    <div id="divdocprint" runat="server">
        <div class="modal fade" id="myModalItinerary" style="margin-left: -316px;">
                    ...
                    <div class="modal-header">
                        <div id="header_text" class="text-center">
                            ...
                            <span id="modal_printbtn" style="float: none; margin-right: 20px;">
                                <a id="print_btn" onclick="PrintContent()"><i class="fa fa-print">Download Itinerary</i></a>
