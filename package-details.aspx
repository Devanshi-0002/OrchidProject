<%@ Page Title="" Language="C#" MasterPageFile="/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="package-details.aspx.cs" Inherits="package_details" ClientIDMode="Static" %>
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12 pr-sm-0">
                            <div class="modal-call-option">
                                <h4 class="text-danger font-weight-bold pb-4"><span class="package-modal-call-icon">
                                    <i class="fas fa-phone img-flip text-white"></i></span><span>Call (+91)6290952054</span></h4>
                                <hr class="w-100" />
