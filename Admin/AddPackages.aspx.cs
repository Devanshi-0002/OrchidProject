...
public partial class Admin_AddPackages : System.Web.UI.Page
{
    ...
    protected void btnsave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            //{
                string eno1 = GenarateEnqNo();// Generate package code
                txtpackagecode.Text = eno1;
                string m_sMessage = "";
                m.dt = null;
                m.dt = new DataTable();
                m.dt.Columns.Add("COLUMN", typeof(string));
                ...
                m.dt.Rows.Add("@Pkg_validity_from", Convert.ToDateTime(txtFromDate.Text));
                m.dt.Rows.Add("@Pkg_validity_to", Convert.ToDateTime(txtDurationToDate.Text));
                ...
                //  m.dt.Rows.Add("@Overview", txt_ItineraryDetailed.Text);//Overview
                if (PkgImg1.HasFile)
                {
                ...
                if (PkgImg5.HasFile)
                {
                    string filepath = Path.GetFileNameWithoutExtension(DateTime.Now.ToString("ddMMyyyy_HHmmss") + "_" + PkgImg5.FileName).ToString() + Path.GetExtension(PkgImg5.FileName).ToString();
                    string path = "~/Upload_image/" + filepath;
                ...
                if (m_sMessage.IndexOf("Error") != 0)
                {
                    ...
                    try
                    {
                        ...
                        foreach (RepeaterItem r in rep1.Items)
                        {
                            ...
                            FileUpload hotelimg2B = (FileUpload)r.FindControl("hotelimg2B");
                            FileUpload hotelimg2C = (FileUpload)r.FindControl("hotelimg2C");
                            ...
                            if (Convert.ToInt32(ddlNoofdays.SelectedValue) >= y)
                            {
                                ...
                                m.dt.Rows.Add("@Departure_Date", Convert.ToDateTime(txt_DepartureDate.Text).ToString("dd/MM/yyyy"));
                                ...
                                m.dt.Rows.Add("@Pkg_id", Session["pkg_id"].ToString());
                                m.dt.Rows.Add("@Created_By", 1);
                                m_sMessage = m.OperateData("sp_tbl_new_PkgMaster", (int)Operation.Insert);
                                if (m_sMessage.IndexOf("Error") != 0)
                                {
                    ...
                    ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('Added Successfully.');", true);
   ...
   public void  getpkgID()
    ...
    protected void ddlselectpkg_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (ddlselectpkg.SelectedItem.Text != "--Select--")
        {
            ...
            pnlupdatedata.Visible = pnlupdatedata2.Visible = false;
            txtpackagename.ReadOnly = true;
            txt_SubPackageName.ReadOnly = true;
            lbl_addnewpackage.Visible = false;
            lbl_HUBDepartureDatee.Visible = true;
            try
            {
                m.dt = null;
                m.dt = new DataTable();
                ...
                {
                    Response.Redirect(ResolveUrl("Addpackages.aspx"));
                }
            }
            catch (Exception ex) { throw ex; }
        }
        else
        {
            ...
            txt_SubPackageName.ReadOnly = false;
            Response.Redirect(ResolveUrl("Addpackages.aspx"));
        }
    }
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (Noofdays.SelectedItem.Value != "1")
                {
                    ...
                    //  foreach (RepeaterItem r in rep1.Items)
                    {
                        ...
                        TextBox txt_RoomType = (TextBox)rep1.Items[t].FindControl("txt_RoomType");
                        ...
                        FileUpload hotelimg2B = (FileUpload)rep1.Items[t].FindControl("hotelimg2");
                        FileUpload hotelimg2C = (FileUpload)rep1.Items[t].FindControl("hotelimg2");
                        ...
                        if (Convert.ToString(ds.Tables[0].Rows[t]["pkg_date"]).ToString() != "")
                        {
                        ...
                        lbl_hotelimg1.Text = ds.Tables[0].Rows[t]["hotel1img"].ToString();
                        lbl_hotelimg1B.Text = ds.Tables[0].Rows[t]["hotel1B_img"].ToString();
                        lbl_hotelimg1C.Text = ds.Tables[0].Rows[t]["hotel1C_img"].ToString();
                        ...
                        if (Convert.ToString(ds.Tables[0].Rows[t]["indate1"]).ToString() != "")
                        {
                        ...
                        if (Convert.ToString(ds.Tables[0].Rows[t]["outdate1"]).ToString() != "")
                        {
                        ...
                        lbl_hotelimg2.Text = ds.Tables[0].Rows[t]["hotel_name2"].ToString();
                        lbl_hotelimg2B.Text = ds.Tables[0].Rows[t]["hotel2B_img"].ToString();
                        lbl_hotelimg2C.Text = ds.Tables[0].Rows[t]["hotel2C_img"].ToString();
    ...
    public void insertItinery()
    {
        try
        {
            ...
            foreach (RepeaterItem r in rep1.Items)
            {
                ...
                TextBox txtmealinclude3 = (TextBox)r.FindControl("txtmealinclude3");
                TextBox txtmealtime3 = (TextBox)r.FindControl("txtmealtime3");
                Label lbl_hotelimg1 = (Label)r.FindControl("lbl_hotelimg1");
                Label lbl_hotelimg1B = (Label)r.FindControl("lbl_hotelimg1B");
                Label lbl_hotelimg1C = (Label)r.FindControl("lbl_hotelimg1C");
                Label lbl_hotelimg2 = (Label)r.FindControl("lbl_hotelimg2");
                Label lbl_hotelimg2B = (Label)r.FindControl("lbl_hotelimg2B");
                Label lbl_hotelimg2C = (Label)r.FindControl("lbl_hotelimg2C");
                //TextBox txtdate = (TextBox)r.FindControl("txtdate");
                if (Convert.ToInt32(ddlNoofdays.SelectedValue) >= y)
                {
                    m_sMessage = "";
                    ...
                    if (txtdate.Text != "")
                    {
                        m.dt.Rows.Add("@pkg_date", Convert.ToDateTime(txtdate.Text).ToString("yyyy-MM-dd"));
                    ...
                    if (txtdepdate1.Text != "")
                    {
                        m.dt.Rows.Add("@flight_datetime1", Convert.ToDateTime(txtdepdate1.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@flight_datetime1", null);
                    ...
                    if (txtarrival.Text != "")
                    {
                        m.dt.Rows.Add("@to_datetime1", Convert.ToDateTime(txtarrival.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@to_datetime1", null);
                    ...
                    if (txtdepdate2.Text != "")
                    {
                        m.dt.Rows.Add("@flight_datetime2", Convert.ToDateTime(txtdepdate2.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@flight_datetime2", null);
                    ...
                    if (txtarrival2.Text != "")
                    {
                        m.dt.Rows.Add("@to_datetime2", Convert.ToDateTime(txtarrival2.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@to_datetime2", null);
                    ...
                    {
                        m.dt.Rows.Add("@hotel1img", lbl_hotelimg1.Text);
                    }
                    if (hotelimg1B.HasFile)
                    {
                        string filepath = Path.GetFileNameWithoutExtension(DateTime.Now.ToString("ddMMyyyy_HHmmss") + "_" + hotelimg1B.FileName).ToString() + Path.GetExtension(hotelimg1B.FileName).ToString();
                    ...
                    {
                        m.dt.Rows.Add("@hotel1B_img", lbl_hotelimg1B.Text);
                    }
                    if (hotelimg1C.HasFile)
                    {
                        string filepath = Path.GetFileNameWithoutExtension(DateTime.Now.ToString("ddMMyyyy_HHmmss") + "_" + hotelimg1C.FileName).ToString() + Path.GetExtension(hotelimg1C.FileName).ToString();
                    ...
                    {
                        m.dt.Rows.Add("@hotel1C_img", lbl_hotelimg1C.Text);
                    }
                    // m.dt.Rows.Add("@hotel1img", hotelimg1.Text);
                    m.dt.Rows.Add("@daynight1", txtduration.Text);
                    m.dt.Rows.Add("@hotel_name1", txthotelname.Text);
                    ...
                    if (txtindate.Text != "")
                    {
                        m.dt.Rows.Add("@indate1", Convert.ToDateTime(txtindate.Text).ToString("yyyy-MM-dd"));
                    ...
                    if (txtcheckout.Text != "")
                    {
                        m.dt.Rows.Add("@outdate1", Convert.ToDateTime(txtcheckout.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@outdate1", null);
                    ...
                    {
                        m.dt.Rows.Add("@hotel2img", lbl_hotelimg2.Text);
                    }
                    if (hotelimg2B.HasFile)
                    {
                        string filepath = Path.GetFileNameWithoutExtension(DateTime.Now.ToString("ddMMyyyy_HHmmss") + "_" + hotelimg2B.FileName).ToString() + Path.GetExtension(hotelimg2B.FileName).ToString();
                    ...
                    {
                        m.dt.Rows.Add("@hotel2B_img", lbl_hotelimg2B.Text);
                    }
                    if (hotelimg2C.HasFile)
                    {
                        string filepath = Path.GetFileNameWithoutExtension(DateTime.Now.ToString("ddMMyyyy_HHmmss") + "_" + hotelimg2C.FileName).ToString() + Path.GetExtension(hotelimg2C.FileName).ToString();
                    ...
                    {
                        m.dt.Rows.Add("@hotel2C_img", lbl_hotelimg2C.Text);
                    }
                    //m.dt.Rows.Add("@hotel2img", hotelimg2.Text);
                    m.dt.Rows.Add("@daynight2", txtduration2.Text);
                    m.dt.Rows.Add("@hotel_name2", txthotelname2.Text);
                    ...
                    if (txtindate2.Text != "")
                    {
                        m.dt.Rows.Add("@indate2", Convert.ToDateTime(txtindate2.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@indate2", null);
                    ...
                    if (txtcheckout2.Text != "")
                    {
                        m.dt.Rows.Add("@outdate2", Convert.ToDateTime(txtcheckout2.Text).ToString("yyyy-MM-dd"));
                    }
                    else
                    {
                        m.dt.Rows.Add("@outdate2", null);
    ...
    protected void btnsave2_Click(object sender, EventArgs e)
    {
        if (ddlselectpkg.SelectedItem.Text != "--Select--")
        {
            //ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('Saved');", true);
            insertItinery();
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('Added Successfully.');", true);
            ddlselectpkg.SelectedIndex = -1;
            txtpackagename.Text = "";
        }
        else
        {
            ScriptManager.RegisterStartupScript(this.Page, this.GetType(), "alert", "alert('Please Select Package Name.');", true);
        }
    }
