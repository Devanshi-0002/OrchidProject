<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/AdminMaster.master" ValidateRequest="false" AutoEventWireup="true"  CodeFile="EditPackage.aspx.cs" Inherits="Admin_EditPackage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPHMainContent" Runat="Server">
	<div class="container-fluid">
		<div class="row mt-3 ml-5 mr-5">
			<div class="col-2 pt-2">
				<span class="font-weight-bold">Select Existing Package</span>
			</div>
			<div class="col">
		...
		<div class="row mt-3 ml-5 mr-5">
			<div class="col">
				<div class="col">
					<div class="row">
						...
						<div class="col">
							<asp:DropDownList runat="server" ID="ddlstartingfrom1" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlstartingfrom1_SelectedIndexChanged"></asp:DropDownList>
						</div>
					</div>
				</div>
			</div>
			<div class="col">
				<div class="row">
					...
					<div class="col">
						<asp:DropDownList runat="server" ID="ddldepDate" AutoPostBack="true" AppendDataBoundItems="false" OnSelectedIndexChanged="ddldepDate_SelectedIndexChanged" CssClass="form-control"></asp:DropDownList>
					</div>
				</div>
			</div>
			<hr class="w-100" />
			...
			<div class="row mt-3 ml-5 mr-5">
				<%--<div class="col">
					<div class="row">
						...
						<div class="col">
							<asp:DropDownList ID="ddlDestinationdomestic" runat="server" Visible="false" CssClass="form-control"></asp:DropDownList>
							<asp:DropDownList ID="ddlDestinationInternational" runat="server" Visible="false" CssClass="form-control"></asp:DropDownList>
						</div>
					</div>
				</div>--%>
				<div class="col">
						...
						<div class="tab-content admin-tab-content-custom ">
							...
							<div class="tab-pane container fade" id="home">
								...
								<div class="row mt-3">
									...
									<br />
								<span> 	Hotel Image 1:</span> <asp:Label ID="lbl_hotelimg1" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg1_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label><br />
								<span>	Hotel Image 2:</span>
									<asp:Label ID="lbl_hotelimg1B" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg1B_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label><br />
									 <span>Hotel Image 3:</span>
									<asp:Label ID="lbl_hotelimg1C" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg1C_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label>
								...
								<br />
								Hotel Image 1 :<asp:Label ID="lbl_hotelimg2" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg2_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label><br />
								Hotel Image 2 :<asp:Label ID="lbl_hotelimg2B" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg2B_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label><br />
								Hotel Image 3 :<asp:Label ID="lbl_hotelimg2C" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
										<asp:Label ID="lbl_hotelimg2C_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label>
							</div>
							
							<div class="tab-pane container fade" id="home">
								<h1 class="h4 font-weight-bold">Sightseeing Details One</h1>
								<div class="row mb-3">
									<div class="col">
									...
									<div class="col-2">
										...
										<asp:TextBox ID="txttime1" type="time" runat="server" CssClass="form-control"></asp:TextBox>
									</div>
								</div>
								<hr class="w-100" />
								<h1 class="h4 font-weight-bold">Sightseeing Details Two</h1>
								<div class="row mb-3">
									<div class="col">
										<asp:Label runat="server">Place Name</asp:Label>
								...
								<hr class="w-100" />
								<h1 class="h4 font-weight-bold">Sightseeing Details Three</h1>
								<div class="row mb-3">
									<div class="col">
										<asp:Label runat="server">Place Name</asp:Label>
								...
								<hr class="w-100" />
								<h1 class="h4 font-weight-bold">Sightseeing Details Four</h1>
								<div class="row mb-3">
									<div class="col">
										<asp:Label runat="server">Place Name</asp:Label>
								...
								<hr class="w-100" />
								<h1 class="h4 font-weight-bold">Sight   seeing Details Five</h1>
								<div class="row mb-3">
									<div class="col">
										<asp:Label runat="server">Place Name</asp:Label>
	...
	<div class="container pb-5 pt-5">
		<asp:Panel ID="pnlupdatedata2" runat="server">
			...
			<div class="row mb-3">
				<div class="col-12 mb-3">
					<asp:Label runat="server" CssClass="h5 font-weight-bold ">For Thumblails<span style="color:red; font-size:11px">* (Image Size 285*300) </span></asp:Label>
				</div>
				<div class="col">
					<asp:FileUpload ID="PkgImg1" runat="server" />
					<asp:Label ID="lbl_PkgImg1" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
					<asp:Label ID="lbl_PkgImg1_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label>
				</div>
			</div>
			<hr />
			<div class="row">
				...
				<div class="col-3">
					...
					<asp:Label ID="lbl_PkgImg2" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
					 <asp:Label ID="lbl_PkgImg2_hidden" Visible="false"  runat="server" Text="No Image"></asp:Label>
				</div>
				<div class="col-3">
					Image 2<span style="color: red">*</span>
					<asp:FileUpload ID="PkgImg3" runat="server" />
					<asp:Label ID="lbl_PkgImg3" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
					 <asp:Label ID="lbl_PkgImg3_hidden"  Visible="false" runat="server" Text="No Image"></asp:Label>
				</div>
				<div class="col-3">
					Image 3<span style="color: red">*</span>
					<asp:FileUpload ID="PkgImg4" runat="server" />
					<asp:Label ID="lbl_PkgImg4" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
					 <asp:Label ID="lbl_PkgImg4_hidden"  Visible="false" runat="server" Text="No Image"></asp:Label>
				</div>
				<div class="col-3">
					Image 4
				<asp:FileUpload ID="PkgImg5" runat="server" />
					<asp:Label ID="lbl_PkgImg5" Font-Bold="true" ForeColor="#0066ff" runat="server" Text="No Image"></asp:Label>
					 <asp:Label ID="lbl_PkgImg5_hidden" Visible="true"  runat="server" Text="No Image"></asp:Label>
				</div>
			</div>
			<br />
			<hr />
		...
		<div class="row">
			<div class="col-10">
				<asp:LinkButton ID="btnsave2" runat="server" CssClass="btn btn-lg btn-info" Visible="false" Text="Update" Style="float: right;" OnClick="btnsave2_Click"></asp:LinkButton>
				<%--<asp:Button ID="btnsave" runat="server" CssClass="btn btn-lg btn-success" OnClick="btnsave_Click" Text="Save" Style="float: right;" />--%>
			</div>
			<div class="col-2">
				<asp:Button ID="btnclear" runat="server" CssClass="btn btn-lg btn-danger" Text="Clear" />
