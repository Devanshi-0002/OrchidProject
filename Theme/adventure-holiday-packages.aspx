<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="adventure-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="adventure_holiday_packages" %>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item destination-carousel-inner active">
                    <img class="d-block w-100 destination-slider-image" src="../img_theme/adventure.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                        <h1>Adventure Packages</h1>
                        <p class="h6 font-weight-light mt-2">Shake off your boring routine with promise of mountains, Valleys and lakes. Get spell - bind and fill your soul with some adventure holidays. Blend yourself with nature and feel the urge of high adrenaline adventure within you. To fulfill all your adventurous need, OrchidGlobal has brought some adventure tour packages exclusively for you. From Bike tours to ladakh to exploring Bhutan by road, we have arranged every kind of amenities to fulfil your urge of adventure holidays in india. Just Scroll your mouse and book India adventure Tour with us right now.!</p>
                    </div>
