<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="honeymoon-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="honeymoon_holiday_packages" %>
    ...
    <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner ">
            <div class="carousel-item destination-carousel-inner active">
                <img class="d-block w-100 destination-slider-image" src="../img_theme/Honeymoon.jpg" alt="First slide">
                <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                    <h1>Honeymoon Packages</h1>
                    <p class="h6 font-weight-light mt-2">Whether its Love or Arrange, every newlywed coupledeserves a dream comes true honeymoon to start a new phrase of their life. We understand you better than anyone else so withbest honeymoon destinations, OrchidGlobal has brought best honeymoon tour packages in front of you.So which destination is in your mind? Is it international or Domestic? Well all we can say is that you are searching in the right website. Scroll and book your honeymoon packages right here and allow us to plan the Best Honeymoon Holiday for you.</p>
                </div>
                                                        ...
                                                        <div class="dastination-package-details">
                                                            ...
                                                            <ul class="dastination-highlight-list">
                                                                ...
                                                                <p class=" ml-sm-4 text-right">
                                                                    <asp:LinkButton ID="LinkButton1" runat="server" class="text-primary" Text="View All" CommandArgument='<%# Eval("Pkg_code")%>' CommandName='<%# Eval("City")%>' OnClick="lnkbtnInternationalBook_Click"></asp:LinkButton></p>
                                                    </li>
