<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="custom-made-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="custom_made_holiday_packages" %>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item destination-carousel-inner active">
                    <img class="d-block w-100 destination-slider-image" src="../img_theme/Custom_Made_Holidays.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                        <h1>Custom made holiday packages</h1>
                        <%--<p class="h6 font-weight-light mt-2">Shake off your boring routine with promise of mountains, Valleys and lakes. Get spell - bind and fill your soul with some adventure holidays.</p>--%>
                    </div>
                                            ...
                                            <ul class="dastination-package-box pr-sm-0 row m-0">
                                                ...
                                                <li class="col p-sm-0">
                                                    <div class="dastination-package-details">
                                                        ...
                                                        <p class="font-weight-bold mb-sm-2"><%# Eval("Heighlights") %> Nights</p>
                                    ...
                                    <div class="dest-sidebar-form-header">
                                        <ul class="row dest-sidebar-form-header-ul">
                                            ...
                                            <li>
                                                ...
                                                <p><span class="text-warning h6 font-weight-bold"><a style="color: #ffcd1f !important;" href="tel:+916290952054Q">(+91)6290952054</a> </span><span>(7am - 10pm)</span></p>
                                            </li>
                                        </ul>
                                    </div>
