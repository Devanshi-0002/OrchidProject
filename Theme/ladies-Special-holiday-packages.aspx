<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="ladies-special-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="ladies_special_holiday_packages" %>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item destination-carousel-inner active">
                    <img class="d-block w-100 destination-slider-image" src="../img_theme/Ladies_Special.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                        <h1>Ladies Special Packages</h1>
                        <p class="h6 font-weight-light mt-2">Move Out, Ladies! Pack your bags because it’s time to see the world. Experience the beauty of your own country and explore other countries of the world. Leave all diminution behind. Thinking of your Safety? Don't worry. OrchidGlobal will take care of all your need. What are you waiting for? Scroll Down and Book now.</p>
                    </div>
