<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="Senior-Citizen-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="Senior_Citizen_holiday_packages" %>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item destination-carousel-inner active">
                    <img class="d-block w-100 destination-slider-image" src="../img_theme/Senior_Citizen.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                        <h1>Senior Citizens Packages</h1>
                        <p class="h6 font-weight-light mt-2">After a certain age, you may be shy and tired of travelling, whatever the reason may be. It's because of your age or your health and we know your mind is still young. With keeping all your problems in mind, OrchidGlobal has brought exclusive Senior citizen Holidays in India. Just Scroll down and book your holidays without any Hassle.</p>
                    </div>
