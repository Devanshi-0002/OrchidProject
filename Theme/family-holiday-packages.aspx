<%@ Page Title="" Language="C#" MasterPageFile="~/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="family-holiday-packages.aspx.cs" ClientIDMode="Static" Inherits="family_holiday_packages" %>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner ">
                <div class="carousel-item destination-carousel-inner active">
                    <img class="d-block w-100 destination-slider-image" src="../img_theme/family.jpg" alt="First slide">
                    <div class="carousel-caption d-none d-md-block dastination-carousel-caption w-75">
                        <h1>Family Packages</h1>
                        <p class="h6 font-weight-light mt-2">Every person wants best for their Family so why not for their Holidays? If you are searching for the best holiday destinations for your family, OrchidGlobal has everything which you are looking for. Be it international Family Package or Domestic Family Packages, you will get the best tour packages over here. Just Scroll down and book your holidays right now. Hustle free.</p>
                    </div>
