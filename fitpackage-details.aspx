<%@ Page Title="" Language="C#" MasterPageFile="/InnerMasterPage.Master" AutoEventWireup="true" CodeFile="fitpackage-details.aspx.cs" Inherits="fitpackage_details" ClientIDMode="Static" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
    <div class="mini-search-row">
        <div class="container">
            ...
            <a id="packagetypeforBreadCrumbs" runat="server" style="color: white"></a>
        </div>
        <div class="container">
            <div class="row">
    ...
    <div class="dastination-slider-area">
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                ...
                <asp:Repeater ID="rpt_sliderImage" runat="server">
                    <ItemTemplate>
                        <div class="carousel-item destination-carousel-inner active w-100">
                            <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Image2") %>' class="d-block w-100 destination-slider-image" />
                        </div>
                        <div class="carousel-item destination-carousel-inner w-100">
                            <asp:Image ID="Image2" runat="server" ImageUrl='<%# Eval("Image3") %>' class="d-block w-100 destination-slider-image" />
                        </div>
                        <div class="carousel-item destination-carousel-inner w-100">
                            <asp:Image ID="Image3" runat="server" ImageUrl='<%# Eval("Image4") %>' class="d-block w-100 destination-slider-image" />
                        </div>
            ...
            <a class="carousel-control-prev dastination-carousel-control-prev" href="#carouselExampleControls" role="button" data-slide="prev"><span class="carousel-control-prev-icon" aria-hidden="true"></span><span class="sr-only">Previous</span>
            </a>
            <a class="carousel-control-next dastination-carousel-control-next" href="#carouselExampleControls" role="button" data-slide="next"><span class="carousel-control-next-icon" aria-hidden="true"></span><span class="sr-only">Next</span>
            </a>
        </div>
        <div class="package-price-box">
            <div class="dastination-slider-price-box package-details-price-tab">
                <%--<h2 class="text-black-50">From <span class="dastination-slider-price-tag-from">INR 2040.00</span>
					</h2>--%>
                ...
                <p>
                    <span>Price Per Adult Twin Sharing Basis </span><span><i class="fas fa-pen-square dastination-slider-price-span"></i></span><u class="dastination-slider-price-span" data-toggle="modal" data-target="#bookNow">Change</u>
                </p>
                <ul class="dastination-slider-price-btn">
                    ...
                    <li><a href="#" class="btn dastination-slider-price-book-btn rounded-0" data-toggle="modal" data-target="#bookNow">Book Now</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="col-12 pl-sm-0">
                    <div class="dastination-package-main">
                        <ul class="nav nav-tabs dastination-nav-tabs mt-4 text-center" role="tablist">
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link active" data-toggle="tab" href="#Overview" role="tab">Overview</a>
                            </li>
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link" data-toggle="tab" href="#home" role="tab">Hotels & Transfer</a>
                            </li>
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link border-left-0" data-toggle="tab" href="#InclusionsExclusions" role="tab">Inclusions & Exclusions</a>
                            </li>
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link" data-toggle="tab" href="#ItineraryDetailed" role="tab">Package Itinerary</a>
                            </li>
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link" data-toggle="tab" href="#Policy" role="tab">Payment & Cancellation Policy</a>
                            </li>
                            <li class="nav-item rounded-0"><a class="nav-link dastination-nav-link" data-toggle="tab" href="#TermsConditions" role="tab">Terms & Conditions</a>
                            </li>
                        </ul>
                        <div class="tab-content pr-sm-0 dastination-tab-content">
                            ...
                            <asp:Label ID="lbl_destination" runat="server" Visible="false"></asp:Label>
                            <%--<asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Image1") %>' class="d-block w-100 destination-slider-image" />--%>
                                                ...
                                                <div class="card rounded-0 border-0 mb-1">
                                                    <div class="card-header bg-transparent row m-0 p-0 border-0 tabpanelforjs1" id="headingOne">
                                                        <div class="col-md-8 col-3 p-0">
                                                            <a class="btn text-left w-100 rounded-0 text-white itn-title-tab tabpanelforjs2 collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Day- <%# Eval("day_count") %> </a>
                                                        </div>
                                                        <div class="col-md-2 col-5 p-0 text-center">
                                                            <p class="btn w-100 border rounded-0 itn-title-tab-date">
                                                                <%# Eval( "pkg_date") %>
                                                            </p>
                                                            <%--day wise date --%>
                                                        </div>
                                                        <div class="col-md-2 col-4 text-center p-0">
                                                            <p class="btn w-100 border border-danger rounded-0 text-danger itn-title-tab-time">
                                                                <span><i class="far fa-clock "></i></span><span><%# Eval("pkg_time") %></span>
                                                            </p>
                                                            <%--TIME--%>
                                                        </div>
                                                    </div>
                                                    <div id="collapseOne" class="collapse tabpanelforjs3 tabpanelforjs4" aria-labelledby="headingOne" data-parent="#accordion">
                                                                    ...
                                                                    <div class="row pb-sm-3 ml-sm-0">
                                                                        <div class="col col-4">
                                                                            <asp:Panel ID="pnl_ss1place" runat="server">
                                                                                <p class="h6">
                                                                                    <span class="font-weight-bold"><i class="fas fa-images text-primary mr-3"></i></span>
                                                                                    <%# Eval( "ss1place") %>
                                                                                </p>
                                                                            </asp:Panel>
                            ...
                            <div class="tab-pane " id="Policy" role="tabpanel">
                                ...
                                <span id="txtPayment_Policy" runat="server"></span>
                                <%--Payment Policy--%>
                                <br />
                                <h4>Cancellation Policy :</h4>
                                <span id="CancellationPolicy" runat="server"></span>
                                <%--Cancellation Policy--%>
                            </div>
                            <div class="tab-pane" id="TermsConditions" role="tabpanel">
                                <span id="txt_TermsAndCondition" runat="server"></span>
                                <%--Terms & Conditions--%>
                            </div>
                            <div class="tab-pane" id="ItineraryDetailed" role="tabpanel">
                                <span id="txt_ItineraryDetailed" runat="server"></span>
                                <%--Itinerary Detailed--%>
                            </div>
                            <div class="tab-pane active" id="Overview" role="tabpanel">
                                <span id="txt_Overview" runat="server"></span>
                                <%--Overview--%>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal animated fadeIn delay-5s " id="bookNow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg package-details-modal-for-enquiry-lg" role="document">
            <div class="modal-content package-details-modal-for-enquiry">
                <div class="modal-header">
                    <h2 class="modal-title">Calculate Price<span id="departure" runat="server"></span></h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                            ...
                            <div class="package-enquiry-modal-form pr-sm-4 pl-sm-3 mt-sm-4">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <asp:TextBox ID="txt_departureDate" runat="server" CssClass="form-control rounded-0" TextMode="Date"></asp:TextBox>
                                        <%--<asp:Calendar ID="Calendar2" runat="server" CellSpacing="1" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="350px" NextPrevFormat="ShortMonth" Width="100%" CssClass="calanderfor-availability" OnDayRender="Calendar2_DayRender1" OnSelectionChanged="Calendar2_SelectionChanged1" OnVisibleMonthChanged="Calendar2_VisibleMonthChanged1">
													<DayHeaderStyle Font-Bold="True" CssClass="jdhaskdhsa" />
													<DayStyle BackColor="#f2f2f2" />
													<NextPrevStyle Font-Bold="True" Font-Size="8pt" ForeColor="#bec4c8" CssClass="dsadadsa" />
													<OtherMonthDayStyle ForeColor="#000000" />
													<SelectedDayStyle BackColor="#da2128" ForeColor="White" />
													<TitleStyle BackColor="#333399" Font-Bold="True" Font-Size="12pt" ForeColor="White" Height="12pt" />
													<TodayDayStyle ForeColor="red" CssClass="dasdfaewdads" />
													</asp:Calendar>--%><span id="lbl_departureDate" runat="server"></span>
                                        <%--desplay departureDate + cost--%>
                                    ...
                                    <div class="col">
                                        <p class="mb-2 font-weight-bold text-danger" title="Price Per Adult Twin Sharing Basis" style="text-align: center">
                                            Starting From <i class="fa fa-info" aria-hidden="true" style="color: black"></i>
                                        </p>
                                        <%--Your Departure City--%>
                                        <h4 class="text-danger font-weight-bold" style="text-align: center">INR <span id="pckcost_onBookbuton" runat="server"></span></h4>
                                    </div>
                                    <span id="lbl_DepartureCity" runat="server" style="display: none"></span>
                                    <div class="col">
                        ...
                        <div class="input_fields_wrap">
                            <div class="row mt-4">
                                ...
                                <div class="col-md-auto col-6 ddlAdultAge">
                                    ...
                                    <small class="text-secondary">(Below 12 yrs)</small>
                                    <%--CHILD AGE 1--%>
                                </div>
                                ...
                                <div class="col-md-auto col-6 ddlAdultAge1">
                                    ...
                                    <small class="text-secondary">(0-2 yrs)</small>
                                    <%--CHILD AGE 2--%>
                                </div>
                ...
                <div class="modal-content" style="width: 900px">
                    <div class="modal-header">
                        <div id="header_text" class="text-center">
                            <button type="button" id="close_btn" class="close" data-dismiss="modal" aria-label="Close" style="font-size: 30px">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            <span id="modal_printbtn" style="float: none; margin-right: 20px;"><a id="print_btn" onclick="PrintContent()"><i class="fa fa-print">Download Itinerary</i></a><%-- <a id="word_btn" class="word-export btn jquery-word-export btn-sm btn-info btn" href="javascript:void(0)"><i class="fa fa-file-word-o" aria-hidden="true"></i></a> <a id="mail_btn" class="btn-sm btn-warning btn" data-toggle="modal" style="cursor: pointer; text-decoration: none; color: #fff" data-target="#myModal2"><i class="fa fa-envelope" aria-hidden="true"></i></a>--%> </span>
                        </div>
                    </div>
                    <div class="row pb-12 ml-0">
                        ...
                        <div class="col-6 pt-6">
                            <h5 class="text-danger font-weight-bold pb-4"><span class="package-modal-call-icon"><i class="fas fa-phone img-flip text-white"></i></span><span>Call (+91)6290952054</span></h5>
                        </div>
                    </div>
                    <hr class="w-100" />
                        ...
                        <div id="modaldivbody" runat="server" style="padding: 15px 0;">
                            <asp:Panel ID="modal_pkg_dtls" runat="server">
                                        ...
                                        <div class="pr-4 pl-2">
                                            <div id="accordion">
                                                <div class="card rounded-0 border-0 mb-1">
                                                    <div class="card-header bg-transparent row m-0 p-0 border-0 tabpanelforjs1" id="headingOne">
                                                        <div class="col-8 p-0">
                                                            <a class="btn text-left w-100 rounded-0 text-white itn-title-tab tabpanelforjs2" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="##collapseOne">Day- <%# Eval("day_count") %> </a>
                                                        </div>
                                ...
                                <div class="tab-pane">
                                    ...
                                    <span id="Overview_print" runat="server"></span>
                                    <%--Overview--%>
                                    <br />
                                    <h4 style="color: #dc3545">Itinerary Detailed :</h4>
                                    <span id="ItineraryDetailed_print" runat="server"></span>
                                    <%--tinerary Detailed--%>
                                </div>
                                <div class="tab-pane">
                                ...
                                <div class="tab-pane">
                                    ...
                                    <span id="PaymentPolicy_print" runat="server"></span>
                                    <%--Cancellation Policy--%>
                                    <br />
                                    <h4 style="color: #dc3545">Cancellation Policy :</h4>
                                    <span id="CancellationPolicy_print" runat="server"></span>
                                    <%--Cancellation Policy--%>
                                </div>
                                <div class="tab-pane">
                                    <h4 style="color: #dc3545">Terms & Conditions :</h4>
                                    <span id="TermsConditions_print" runat="server"></span>
                                    <%--Terms & Conditions--%>
                                </div>
                            </asp:Panel>
                        </div>
    ...
    <script>
        $(document).ready(function(){$(".btn-number").on("click",function(d){fieldName=$(this).attr("data-field"),type=$(this).attr("data-type");var e=$("input[name='"+fieldName+"']"),l=parseInt(e.val());isNaN(l)?e.val(0):"minus"==type?(l>e.attr("min")&&e.val(l-1).change(),parseInt(e.val())===e.attr("min")&&$(this).attr("disabled",!0)):"plus"===type&&(l<e.attr("max")&&e.val(l+1).change(),parseInt(e.val())==e.attr("max")&&$(this).attr("disabled",!0))}),$(".input-number").focusin(function(){$(this).data("oldValue",$(this).val())}),$(".input-number").change(function(){minValue=parseInt($(this).attr("min")),maxValue=parseInt($(this).attr("max")),valueCurrent=parseInt($(this).val()),name=$(this).attr("name"),valueCurrent>=minValue?$(".btn-number[data-type='minus'][data-field='"+name+"']").removeAttr("disabled"):(alert("Sorry, the minimum value was reached"),$(this).val($(this).data("oldValue"))),valueCurrent<=maxValue?$(".btn-number[data-type='plus'][data-field='"+name+"']").removeAttr("disabled"):(alert("Sorry, the maximum value was reached"),$(this).val($(this).data("oldValue")))}),$(".input-number").keydown(function(d){-1!==$.inArray(d.keyCode,[46,8,9,27,13,190])||65==d.keyCode&&!0===d.ctrlKey||35<=d.keyCode&&d.keyCode<=39||(d.shiftKey||d.keyCode<48||57<d.keyCode)&&(d.keyCode<96||105<d.keyCode)&&d.preventDefault()});}),$(document).ready(function(){$(function(){$("#div_2nd").hide(),$("#div_3rd").hide(),$(".aanwithb").hide(),$(".aanwithoutb").hide(),$(".aanwithb1").hide(),$(".aanwithoutb1").hide(),$(".aanwithb2").hide(),$(".aanwithoutb2").hide(),$("#btnadd1").on("click",function(d){$("#div_2nd").show(),$("#btnadd1").hide(),$("#ddlchildAge3").prop("disabled",!0).addClass("disabled"),$("#ddlchildAge4").prop("disabled",!0).addClass("disabled"),$("#DropDownList2").prop("disabled",!0).addClass("disabled"),d.preventDefault();}),$("#btnadd2").on("click",function(d){$("#div_3rd").show(),$("#btnadd2").hide(),$("#btn_minus1").hide(),$("#ddlchildAge5").prop("disabled",!0).addClass("disabled"),$("#ddlchildAge6").prop("disabled",!0).addClass("disabled"),$("#DropDownList3").prop("disabled",!0).addClass("disabled"),d.preventDefault();}),$("#btnminus3").on("click",function(d){$("#div_3rd").hide(),$("#btnadd2").show(),$("#btn_minus1").show(),$("#ddlAdults3").prop("selectedIndex",0),$("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge6").prop("selectedIndex",0),$("#DropDownList3").prop("selectedIndex",0),d.preventDefault();}),$("#btn_minus1").on("click",function(d){$("#div_2nd").hide(),$("#btnadd1").show(),$("#ddlAdults2").prop("selectedIndex",0),$("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge4").prop("selectedIndex",0),$("#DropDownList2").prop("selectedIndex",0),d.preventDefault();}),$(document).on("change","#ddlchildAge1",function(){$(".aanwithb").show();}),$(document).on("change","#ddlchildAge2",function(){$(".aanwithoutb").show();}),$(document).on("change","#ddlchildAge3",function(){$(".aanwithb1").show();}),$(document).on("change","#ddlchildAge4",function(){$(".aanwithoutb1").show();}),$(document).on("change","#ddlchildAge5",function(){$(".aanwithb2").show();}),$(document).on("change","#ddlchildAge6",function(){$(".aanwithoutb2").show();}),$(document).on("change","#ddlAdults1",function(){"3"===$(this).val()?($("#ddlchildAge1").prop("selectedIndex",0),$("#DropDownList4").prop("selectedIndex",0),$(".aanwithb").hide(),$("#ddlchildAge1").prop("disabled",!0).addClass("disabled")):$("#ddlchildAge1").prop("disabled",!1).removeClass("disabled");}),$(document).on("change","#ddlAdults2",function(){$("#ddlchildAge3").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge4").prop("disabled",!1).removeClass("disabled"),$("#DropDownList2").prop("disabled",!1).removeClass("disabled"),"3"===$(this).val()?($("#DropDownList6").prop("selectedIndex",0),$(".aanwithb1").hide(),$("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge3").prop("disabled",!0).addClass("disabled")):$("#ddlchildAge3").prop("disabled",!1).removeClass("disabled");}),$(document).on("change","#ddlAdults3",function(){$("#ddlchildAge6").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge5").prop("disabled",!1).removeClass("disabled"),$("#DropDownList3").prop("disabled",!1).removeClass("disabled"),"3"===$(this).val()?($("#DropDownList8").prop("selectedIndex",0),$(".aanwithb2").hide(),$("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge5").prop("disabled",!0).addClass("disabled")):$("#ddlchildAge5").prop("disabled",!1).removeClass("disabled");});});var d=function(d,e){e||(e=window.location.href),d=d.replace(/[[]]/g,"\$&");var l=new RegExp("[?&]"+d+"(=([^&#]*)|&|#|$)").exec(e);return l?l[2]?decodeURIComponent(l[2].replace(/+/g," ")):"":null}("Zenith");$(document).ready(function(){"ERU112"===d&&$(function(){$(document).on("change","#ddlAdults1",function(){"3"===$(this).val()?($("#ddlchildAge1").prop("selectedIndex",0),$("#ddlchildAge2").prop("selectedIndex",0),$("#ddlchildAge2").prop("disabled",!0).addClass("disabled"),$("#ddlchildAge1").prop("disabled",!0).addClass("disabled")):"2"===$(this).val()?($("#ddlchildAge1").prop("selectedIndex",0),$("#ddlchildAge2").prop("selectedIndex",0),$("#ddlchildAge2").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge1").prop("disabled",!1).removeClass("disabled")):"1"===$(this).val()&&($("#ddlchildAge1").prop("selectedIndex",0),$("#ddlchildAge2").prop("selectedIndex",0),$("#ddlchildAge2").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge1").prop("disabled",!1).removeClass("disabled"))}),$(document).on("change","#ddlchildAge1",function(){"1"===$(this).val()?$("#ddlAdults1 option[value='1']").is(":selected")?$("#ddlchildAge2").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge2").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge2").prop("disabled",!1).removeClass("disabled")}),$(document).on("change","#ddlchildAge2",function(){"1"===$(this).val()?$("#ddlAdults1 option[value='1']").is(":selected")?$("#ddlchildAge1").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge1").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge1").prop("disabled",!1).removeClass("disabled")}),$(document).on("change","#ddlAdults2",function(){$("#ddlchildAge3").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge4").prop("disabled",!1).removeClass("disabled"),$("#DropDownList2").prop("disabled",!1).removeClass("disabled"),"3"===$(this).val()?($("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge4").prop("selectedIndex",0),$("#ddlchildAge3").prop("disabled",!0).addClass("disabled"),$("#ddlchildAge4").prop("disabled",!0).addClass("disabled")):"2"===$(this).val()?($("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge4").prop("selectedIndex",0)):"1"===$(this).val()?($("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge4").prop("selectedIndex",0)):"0"===$(this).val()?($("#ddlchildAge3").prop("selectedIndex",0),$("#ddlchildAge4").prop("selectedIndex",0)):($("#ddlchildAge3").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge4").prop("disabled",!1).removeClass("disabled"))}),$(document).on("change","#ddlchildAge3",function(){"1"===$(this).val()?$("#ddlAdults2 option[value='1']").is(":selected")?$("#ddlchildAge4").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge4").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge4").prop("disabled",!1).removeClass("disabled")}),$(document).on("change","#ddlchildAge4",function(){"1"===$(this).val()?$("#ddlAdults2 option[value='1']").is(":selected")?$("#ddlchildAge3").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge3").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge3").prop("disabled",!1).removeClass("disabled")}),$(document).on("change","#ddlAdults3",function(){$("#ddlchildAge6").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge5").prop("disabled",!1).removeClass("disabled"),$("#DropDownList3").prop("disabled",!1).removeClass("disabled"),"3"===$(this).val()?($("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge6").prop("selectedIndex",0),$("#ddlchildAge5").prop("disabled",!0).addClass("disabled"),$("#ddlchildAge6").prop("disabled",!0).addClass("disabled")):"2"===$(this).val()?($("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge6").prop("selectedIndex",0)):"1"===$(this).val()?($("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge6").prop("selectedIndex",0)):"0"===$(this).val()?($("#ddlchildAge5").prop("selectedIndex",0),$("#ddlchildAge6").prop("selectedIndex",0)):($("#ddlchildAge5").prop("disabled",!1).removeClass("disabled"),$("#ddlchildAge6").prop("disabled",!1).removeClass("disabled"))}),$(document).on("change","#ddlchildAge5",function(){"1"===$(this).val()?$("#ddlAdults3 option[value='1']").is(":selected")?$("#ddlchildAge6").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge6").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge6").prop("disabled",!1).removeClass("disabled")}),$(document).on("change","#ddlchildAge6",function(){"1"===$(this).val()?$("#ddlAdults3 option[value='1']").is(":selected")?$("#ddlchildAge5").prop("disabled",!1).removeClass("disabled"):$("#ddlchildAge5").prop("disabled",!0).addClass("disabled"):$("#ddlchildAge5").prop("disabled",!1).removeClass("disabled")})})})}),$(document).ready(function(){$(".tabpanelforjs1").each(function(d){$(this).attr("id","headingOne"+(d+1))}),$(".tabpanelforjs2").each(function(d){$(this).attr("data-target","#collapseOne"+(d+1))}),$(".tabpanelforjs3").each(function(d){$(this).attr("id","collapseOne"+(d+1))}),$(".tabpanelforjs4").each(function(d){$(this).attr("aria-labelledby","headingOne"+(d+1))}),$(".itn-title-tab").each(function(d){$(this).attr("aria-controls","collapseOne"+(d+1))}),$("#btn_saveEnq").on("click",function(d){var e=$("#txt_YourName").val(),l=$("#txt_emailid").val(),a=$("#txt_mobileno").val(),s=$("#txt_cityname").val(),i=$("#txt_traveldate").val();""===e?(alert("Please input Your name"),$("#txt_YourName").addClass("is-invalid"),d.preventDefault()):""===l?(alert("Please input Your Email"),$("#txt_emailid").addClass("is-invalid"),d.preventDefault()):""===a?(alert("Please input Your Phone no"),$("#txt_mobileno").addClass("is-invalid"),d.preventDefault()):""===s?(alert("Please input Your City"),$("#txt_cityname").addClass("is-invalid"),d.preventDefault()):""===i?(alert("Please input Your Date Of Birth"),$("#txt_traveldate").addClass("is-invalid")):$(".validation").addClass("is-valid")})});
    </script>
    ...
    <script type="text/javascript">
        function PrintContent(){var printContents=document.getElementById('myModalItinerary').innerHTML;var originalContents=document.body.innerHTML;document.body.innerHTML=printContents;document.getElementById('print_btn').style.display="none";document.getElementById('close_btn').style.display="none";document.getElementById('header_text').style.textAlign="center";window.print();document.body.innerHTML=originalContents;document.getElementById('myModal').style.display='none';return false;} $(document).ready(function(){$('[data-toggle="tooltip"]').tooltip();});
    </script>
    <script>
        $("#lnlbtn_checkoutsubmit").on('click',function(e){var State=$('#ddlCustomerState').val();var dpDate=$('#txt_departureDate').val();if(dpDate===''){alert("Please input Your Departure Date");$('#txt_departureDate').addClass("is-invalid");e.preventDefault();} else if(State==='---Select State---'){alert("Please Select your State");$('#ddlCustomerState').addClass("is-invalid");e.preventDefault();} else{$('.validation').addClass("is-valid");}});
    </script>
    <%--<script type="text/javascript">$(function(){$("[id*=txt_departureDate]").datepicker({showOn:'button',buttonImageOnly:true,buttonImage:'img/calendar.png'});});</script>--%>
    <%-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/1.8/jquery.min.js" type="text/javascript"></script>
							<script src="https://ajax.googleapis.com/ajax/libs/jqueryui/1.8/jquery-ui.min.js" type="text/javascript"></script>
							<link href="https://ajax.googleapis.com/ajax/libs/jqueryui/1.4/themes/base/jquery-ui.css" rel="Stylesheet" type="text/css" />--%>
    <%--<script type="text/javascript">$(function(){$("#txt_departureDate").datepicker({changeMonth:true,changeYear:true,altField:"#txt_departureDate",altFormat:"dd/mm/yy",});});</script>--%>
</asp:Content>
