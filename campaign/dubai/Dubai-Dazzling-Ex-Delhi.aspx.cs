...
public partial class DubaiEXDelhi : System.Web.UI.Page
{
    string source = "";
    ...
    protected void btn_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ml.savemaildetail(txtnamep.Value, emailp.Value, phonp.Value, packagep.Value, cityp.Value, " ", 0, "GIT", "Dubai EX-Delhi", source);
