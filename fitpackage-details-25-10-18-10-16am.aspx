...
<asp:Content ID="Content2" ContentPlaceHolderID="BodyContentPlaceHolder" runat="server">
                    ...
                    <div class="dastination-package-main">
                        <ul class="nav nav-tabs dastination-nav-tabs mt-4 text-center" role="tablist">
                             <li class="nav-item rounded-0">
                                <a class="nav-link dastination-nav-link active" data-toggle="tab" href="#Overview" role="tab">Overview</a>
                            </li>
                            <li class="nav-item rounded-0">
                                <a class="nav-link dastination-nav-link" data-toggle="tab" href="#home" role="tab">Hotels & Transfer</a>
                            </li>
                            <li class="nav-item rounded-0">
                                                ...
                                                <div class="card rounded-0 border-0 mb-1">
                                                    <div class="card-header bg-transparent row m-0 p-0 border-0 tabpanelforjs1" id="headingOne">
                                                        <div class="col-md-8 col-3 p-0">
                                                            <a class="btn text-left w-100  rounded-0 text-white itn-title-tab tabpanelforjs2 collapsed" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">Day- <%# Eval("day_count") %>
                                                            </a>
                                                        </div>
    ...
    <div class="modal animated fadeIn delay-5s " id="bookNow" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
        <div class="modal-dialog modal-lg package-details-modal-for-enquiry-lg" role="document">
            <div class="modal-content package-details-modal-for-enquiry">
                <div class="modal-header">
                    <h2 class="modal-title">Calculate Price<span id="departure" runat="server"></span>
                    </h2>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                        ...
                        <div class="col-md-8 col-sm-12 pr-sm-0">
                            ...
                            <div class="package-enquiry-modal-form pr-sm-4 pl-sm-3 mt-sm-4">
                                <div class="row">
                                    ...
                                    <div class="col">
                                        <p class="mb-2 font-weight-bold text-danger" title="Price Per Adult Twin Sharing Basis" style="text-align: center">Starting From <i class="fa fa-info" aria-hidden="true" style="color:black"></i></p>
                                        <%--Your Departure City--%>
                ...
                <div class="modal-content" style="width: 900px">
                    ...
                    <div class="modal-header">
                        <div id="header_text" class="text-center">
                            <button type="button" id="close_btn" class="close" data-dismiss="modal" aria-label="Close" style="font-size:30px"><span aria-hidden="true">&times;</span></button>
    ...
    <script>
        $("#lnlbtn_checkoutsubmit").on('click', function (e) {
            ...
            var dpDate = $('#txt_departureDate').val();

            if (dpDate === '') {
                alert("Please input Your Departure Date");
                $('#txt_departureDate').addClass("is-invalid");
                e.preventDefault();
            }
    ...
    <%--<script type="text/javascript">
        $(function () {
            $("[id*=txt_departureDate]").datepicker({
                showOn: 'button',
    ...
    <%--<script type="text/javascript">
        $(function () {
            $("#txt_departureDate").datepicker({
                changeMonth: true,
                changeYear: true,
                altField: "#txt_departureDate",
                altFormat: "dd/mm/yy",
                //minDate: "-0D",
                //beforeShowDay: function (date) {
                //    var d = new Date();
                //    var startDate = "11-10-2018", // some start date
                //        endDate = "11-10-2025",  // some end date
